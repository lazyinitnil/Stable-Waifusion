...
fun CardWithAnimatedBorder(
    ...
    externalShape: RoundedCornerShape = RoundedCornerShape(20.dp),
    innerShape: RoundedCornerShape = RoundedCornerShape(10.dp),
    ...
    infiniteTransition.animateFloat(
        ...
        animationSpec =
        infiniteRepeatable(
            animation = tween(2100, easing = LinearEasing, delayMillis = 0),
    ...
    Surface(modifier = modifier.clickable { onCardClick() }, shape = externalShape) {
        Surface(
            modifier =
